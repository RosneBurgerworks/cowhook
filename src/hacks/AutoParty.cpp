...
{
// Enable auto-party?
static settings::Boolean enabled{ "autoparty.enable", "true" };
...
static settings::Boolean kick_rage{ "autoparty.kick-rage", "false" };
...
static settings::Boolean auto_lock{ "autoparty.auto-lock", "faslse" };
...
static settings::Boolean autoparty_log{ "autoparty.log", "false" };
// Log kick notifications to party chat
static settings::Boolean message_kicks{ "autoparty.message-kicks", "false" };
