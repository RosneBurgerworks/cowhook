...
public:
    ...
    EntityType m_Type()
    {
        ...
        else if (classid == CL_CLASS(CTFBaseBoss) || classid == CL_CLASS(CZombie) || classid == CL_CLASS(CTFTankBoss) || classid == CL_CLASS(CMerasmus) || classid == CL_CLASS(CMerasmusDancer) || classid == CL_CLASS(CEyeballBoss) || classid == CL_CLASS(CHeadlessHatman))
            return ENTITY_NPC;
        else
